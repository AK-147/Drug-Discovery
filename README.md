...
<body>
  ...
  <ul>
    <li><strong><a href="https://github.com/AK-147/Drug-Discovery/tree/main/App">App</a></strong> has the relevant components to run the Streamlit application, including a script to generate descriptors.</li>
    <li><strong><a href="https://github.com/AK-147/Drug-Discovery/tree/main/Data">Data</a></strong> stores the bioactivity data for the molecule in <strong>.csv</strong> format used for analysis and training the model.</li>
  ...
  <p>
    To run the app locally, clone the repository and enter the following command:
